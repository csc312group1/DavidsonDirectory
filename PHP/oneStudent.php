...
$oneStu = $st->findOne(['campus_email' => $email]);

$LastName = $oneStu['last_name'];
$FirstName = $oneStu['first_name'];
$phone = $oneStu['phone'];
$class = $oneStu['dc_class'];
$box = $oneStu['campus_box'];
  ...
  <div class="col-8">
    ...
    <div class="lightBack" style="border-radius: 0.4em;">
      <p class="smallerIndent bigPfont"><br>
        <strong>Class Year:          </strong>  <?php echo $class ?> <br>
