...
if($LastName == ""){
$student = $fs->find(['first_name' => $FirstName]);
foreach ($student as $row) {
echo "<tr class='whiteFont'>
    <td><a href='oneStudent.php?name=$row[campus_email]'> $row[first_name] </a></td> 
    <td><a href='oneStudent.php?name=$row[campus_email]'> $row[last_name] </a></td> 
    <td>$row[campus_email]</td>
  </tr>";
}
}
else if($FirstName == ""){
$student = $fs->find(['last_name' => $LastName]);
foreach ($student as $row) {
echo "<tr class='whiteFont'>
   <td><a href='oneStudent.php?name=$row[campus_email]'> $row[first_name] </a></td> 
    <td><a href='oneStudent.php?name=$row[campus_email]'> $row[last_name] </a></td> 
...
$student = $fs->find(['first_name' => $FirstName], ['last_name' => $LastName]);
foreach ($student as $row) {
echo "<tr class='whiteFont'>
    <td><a href='oneStudent.php?name=$row[campus_email]'> $row[first_name] </a></td> 
    <td><a href='oneStudent.php?name=$row[campus_email]'> $row[last_name] </a></td> 
